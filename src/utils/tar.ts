// Adapted from @expo/cli:
// https://github.com/expo/expo/blob/2c21e2f96ce6aede3d6bb5c780f0964d2116d37b/packages/@expo/cli/src/utils/tar.ts#L1-L146
...
const debug = (message: string): void => Log.debug(`[utils:tar] ${message}`);
...
/** Extract a gzip-compressed tar archive using a streaming JavaScript implementation. */
